...
var buildStatic = flag.Bool("static", false, "Adds linker options to build statically binaries where possible")
...
func main() {
	...
	if err := compile(flag.Args()[0], image, *srcRemote, *srcBranch, *inPackage, *crossDeps, *outPrefix, *buildVerbose,
		*buildRace, *buildStatic, *beforeBuildScript); err != nil {
...
func compile(repo string, image string, remote string, branch string, pack string, deps string, prefix string,
	verbose bool, race bool, static bool, beforeBuild string) error {
